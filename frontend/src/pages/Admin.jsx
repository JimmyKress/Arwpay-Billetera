      ...
      <div className="modal-overlay" onClick={closeCuponesMasivos}>
        ...
        >
          ...
          <div className="form-grid" style={{ marginBottom: 10 }}>
            ...
            <div className="form-group">
              <label style={{ color: '#ffff' }}>COMISION ARW PAY (%)</label>
              <input
                type="number"
            ...
            <div className="form-group">
              <label style={{ color: '#ffff' }}>IVA COMISIÓN ARW PAY (%)</label>
              <input
                type="number"
      ...
      <div className="cupon-form-card">
        ...
        <form onSubmit={handleCrearCupon}>
          ...
          <div className="form-grid">
            ...
            <div className="form-group">
              <label>MONTO ARW pay PROCESSING*</label>
            ...
            <div className="form-group">
              <label>IVA COMISIÓN ARW PAY (%)</label>
              <input
                type="number"
                name="iva_comision_flux_pct"
                value={cuponForm.iva_comision_flux_pct}
          ...
          <table className="cupones-table">
            <thead>
              <tr>
                ...
                <th>Código</th>
                <th>Cliente (CUIT)</th>
                <th>MONTO BRUT LIQ ARW PAY</th>
                <th>COMISION ARW PAY (%)</th>
