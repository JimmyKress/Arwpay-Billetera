...
//ENLACE DE REDIRECCION QR
  ...
  const downloadCuponExcel = (cupon) => {
    try {
      ...
      const origenNombre = cupon?.nombre_comercio || cupon?.razon_social || cupon?.comercio || cupon?.origen_nombre || 'ARW pay PROCESSING';
    ...
    <div className="wallet-container">
      ...
      {(() => {
        ...
        window.cuponModalVars = {
          ...
          origenNombre: cuponAcreditadoData?.nombre_comercio || cuponAcreditadoData?.razon_social || cuponAcreditadoData?.comercio || cuponAcreditadoData?.origen_nombre || 'ARW pay PROCESSING',
      ...
      <Modal open={showCuponAcreditadoModal} onClose={closeCuponAcreditadoModal} style={{ maxWidth: '400px' }}>
        {(() => {
          ...
          const origenNombre = cuponAcreditadoData?.nombre_comercio || cuponAcreditadoData?.razon_social || cuponAcreditadoData?.comercio || cuponAcreditadoData?.origen_nombre || 'ARW pay PROCESSING';
  ...
  <>
    ...
    >
      ...
      >
        <div style={{ padding: '8px', background: '#86efac' }}>
