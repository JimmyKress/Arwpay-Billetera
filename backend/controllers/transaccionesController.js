  ...
  const html = `
      <div style="font-family: Arial, Helvetica, sans-serif; background:#ffffff; padding:24px;">
        <div style="max-width:720px; margin:0 auto; border:1px solid #e5e7eb; border-radius:12px; overflow:hidden;">
          ...
          <div style="background:#059669; color:#0f172a; padding:10px 16px; font-weight:900; text-align:center;">Liquidación a Comercios</div>
          ...
          <div style="padding:18px 20px; background:#ffffff;">
            ...
            <div style="margin-top:14px; background:#064e3b; color:#fff; font-weight:900; text-align:center; padding:10px; border-radius:10px;">Detalles del cupón</div>

            <div style="margin-top:10px; border:0px solid #fbcfe8; border-radius:10px; overflow:hidden;">
              <div style="display:flex; gap:0; padding:1px; background:#86efac;">
            ...
            <div style="margin-top:14px; background:#064e3b; color:#fff; font-weight:900; text-align:center; padding:10px; border-radius:10px;">Descuentos</div>

            <div style="margin-top:10px; border:1px solid #86efac; border-radius:10px; overflow:hidden;">
              <div style="padding:12px; background:#86efac;">
                <table style="width:100%; border-collapse:collapse;">
                  <tr>
                    <td style="font-size:12px; font-weight:900; color:#111827; padding:6px 0;">COMISION ARW PAY</td>
                    <td style="font-size:12px; font-weight:900; color:#111827; padding:6px 0; text-align:right;">$${formatCurrency(comision)}</td>
                  </tr>
                  <tr>
                    <td style="font-size:12px; font-weight:900; color:#111827; padding:6px 0;">IVA COMISIÓN ARW PAY</td>
