...
export const obtenerPerfilCliente = async (req, res) => {
  try {
    ...
    const [clientes] = await db.query(
      `SELECT c.id, c.cuit, c.razon_social, c.cbu_registro, c.banco, c.edad, c.direccion, c.ubicacion, c.sexo, c.alias, c.config_retiro_automatico, c.liquidacion_diaria, c.wallet_mode, u.email
       FROM clientes c 
